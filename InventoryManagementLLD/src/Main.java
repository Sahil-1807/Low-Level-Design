...
import InventoryManagementLLD.ProductDeliverySystem;
import InventoryManagementLLD.Strategy.NearestWarehouseSelectionStrategy;
...
public class Main {
    ...
    private static Warehouse addWarehouseAndItsInventory(){
        System.out.println("Making warehouse and it's inventory");
